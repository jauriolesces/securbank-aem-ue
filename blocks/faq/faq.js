...
export default async function decorate(block) {
  ...
  const url = `https://author-p56818-e741270.adobeaemcloud.com/graphql/execute.json/securbank/FAQListbyTag;tag=${firsttag};variation=${variationname}?ts=${cachebuster}`;
  const options = {};
